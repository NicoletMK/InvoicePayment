...
const Invoices11: NextPage = () => {
  return (
    <div className="relative bg-gray-300 w-full h-[1024px] overflow-hidden text-left text-base text-gray-100 font-helvetica-neue">
      <div className="relative  top-[100px] left-[215px] rounded-xl bg-gray-200 box-border w-[1257px] h-[884px] overflow-hidden text-17xl border-[2px] border-solid border-darkslategray-100">
        <div className="relative   top-[0px] left-[0px] rounded-tl-xl rounded-tr-none rounded-b-none bg-gray-200 box-border w-[1257px] h-20 overflow-hidden border-[2px] border-solid border-darkslategray-100">
          <b className="relative  top-[18px] left-[40px]">Summary</b>
        </div>
        <div className="absolute  top-[100px] left-[40px] w-[1177px] h-[764px] text-base text-lightslategray">
          <div className="absolute  top-[0px] left-[0px] rounded-3xs bg-gray-300 box-border w-[1177px] h-[764px] overflow-hidden text-5xl text-gray-100 border-[1px] border-solid border-darkslategray-100">
            ...
            <div className="absolute  h-[calc(100%_-_125px)] top-[25px] right-[15px] bottom-[100px] w-[11px] overflow-hidden">
              <div className="absolute  top-[1px] left-[1px] rounded-9xs-5 bg-gray-200 box-border w-[9px] h-[584px] border-[1px] border-solid border-gray-400" />
            </div>
           <InvoiceHistory />
         </div>
        </div>
      ...
      <div className="absolute top-[100px] left-[40px] rounded-xl box-border w-[145px] h-[660px] overflow-hidden text-center border-[2px] border-solid border-darkslategray-100">
        ...
        <div className="absolute top-[125px] left-[21px] rounded-3xs bg-steelblue-100 w-[104px] h-[95px] overflow-hidden">
          <div className="absolute top-[0px] left-[0px] rounded-tl-3xs rounded-tr-none rounded-br-none rounded-bl-3xs bg-steelblue-100 shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] w-3 h-[60px] overflow-hidden hidden" />
      ...
      <div className="absolute top-[0px] left-[0px] bg-gray-300 w-[1512px] h-[100px] overflow-hidden font-inter">
        ...
        <img
          ...
          alt=""
          src="/mdibellnotificationoutline1.svg"
        />
        <img
          className="absolute top-[30px] left-[1428px] w-10 h-10"
          alt=""
          src="/group-340504.svg"
        />
